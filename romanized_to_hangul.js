// Romanized to hangul converter from https://www.mauvecloud.net/charsets/hangulgenerator.html
...
function performConversion(input) {
  ...
  // input.hangul.value = hangul.substring(0, hangul.length - 1);
  return hangul.substring(0, hangul.length - 1);
}